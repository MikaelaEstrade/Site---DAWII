                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" action="produto-cadastra-ok.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label>Produto</label>
                                                <input class="form-control" placeholder="Produto" name="produto" required="true">
                                            </div>
                                           
                                             <div class="form-group">
                                                <label>Descrição</label>
                                                <input class="form-control" placeholder="Descrição" name="descricao" required="true">
                                            </div>
                                            
                                             <div class="form-group">
                                                <label>Preço</label>
                                                <input class="form-control" placeholder="Preço" name="preco" required="true">
                                            </div>
                                            
                                             <div class="form-group">
                                                <label>Imagem</label>
                                                <input class="form-control" type="file" placeholder="Imagem" name="imagem" required="true">
                                            </div>
