                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <button type="button" onclick="window.location='categoria-lista.php'"class="btn btn-outline btn-primary">Pesquisar</button>
                           <button type="button" onclick="window.location='categoria-cadastra.php'" class="btn btn-outline btn-primary">Novo</button>
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                       <?php foreach($lista as $categoria): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" onclick="window.location='categoria-edita.php?id=<?php echo $categoria->getId(); ?>';" class="btn btn-outline btn-primary    
">Editar</button>
<button type="button" onclick="confirm('Deseja exclir este registro?') ? window.location='categoria-deleta-ok.php?id=<?php echo $categoria->getId(); ?>' : stop = false;" class="btn btn-outline btn-danger">Deletar</button>
                                            </td>
                                        </tr>
                                       <?php endforeach; ?> 
