                                    ...
                                    <div class="col-lg-6">
                                        <form role="form" action="produto-edita-ok.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label>Produto</label>
                                                <input class="form-control" value="<?php echo $produtoData->getProduto(); ?>" placeholder="Produto" name="produto" required="true">
                                            </div>
                                           
                                             <div class="form-group">
                                                <label>Descrição</label>
                                                <input class="form-control" value="<?php echo $produtoData->getDescricao(); ?>"placeholder="Descrição" name="descricao" required="true">
                                            </div>
                                            
                                             <div class="form-group">
                                                <label>Preço</label>
                                                <input class="form-control" value="<?php echo $produtoData->getPreco(); ?>" placeholder="Preço" name="preco" required="true">
                                            </div>
                                            
                                             <div class="form-group">
                                                <label>Imagem</label>
                                                <input class="form-control" value="<?php echo $produtoData->getImagem(); ?>" placeholder="Imagem" name="imagem" required="true">
                                            </div>
