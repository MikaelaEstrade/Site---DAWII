                                    ...
                                    <div class="col-lg-6">
                                        <form role="form" action="categoria-cadastra-ok.php" method="POST">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="ategoria" name="categoria" required="true">
                                            </div>
                                           
                                            <div class="form-group">
                                                <label>Descrição</label>
                                                <input type="text" class="form-control" placeholder="Descrição da categoria" name="categoria" required="true">
                                            </div>
